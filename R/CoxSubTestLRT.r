#' The likelihood ratio test for Cox proportional hazard model with a change plane.
#'
...
#' @param maxs A constant. The maximum number of iterations in Newton method. Default is 20.
...
#' Cox Change plane test by LRT
CoxSubTestLRT <- function(data, Gamma, B = 1000, K = 1000, qlb = 0.1, tol = 1e-8, seed = 1, maxs = 20, saveall = FALSE) {
    tic1 = proc.time()
